            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {TESTIMONIALS.map((testimonial, index) => (
                        ...
                        >
                            {/*Quote Icon*/}
                            <div className="absolute -top-4 -left-4 w-12 h-12 bg-linear-to-br from-violet-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/30 rotate-12 transition-transform duration-300">
                            ...
                            <div className="flex items-center space-x-4">
                                <div className="relative ">
                                    <div className="absolute inset-0 bg-linear-to-br from-violet-500 to-purple-600 rounded-full blur-sm opacity-25"></div>
                                    <img
